...
if (isset($_POST['cpf'])) {
    ...
    if ($cliente) {
        ...
        // Gerar o HTML da carteira digital com a foto do cliente e o QR code
        $html = '
            <!DOCTYPE html>
            <html lang="pt-BR">
            <head>
            ...
            <body>
                ...
                <div class="carteira">
                    ...
                    <div class="qrcode">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?data=' . urlencode($user_id) . '&size=150x150" alt="QR Code" style="width: 150px;">
                    </div>
                </div>
            </body>
            </html>
        ...
        // Exibir o HTML da carteira digital
        echo $html;
        exit();
    }
}
